...
describe('DropdownAsyncScrollableComponent', () => {
  it('opening loads page 0', fakeAsync(() => {
    const loadPage = vi.fn((q: string, p: number) => of(page(p, 3)));
    const fixture = TestBed.createComponent(DropdownAsyncScrollableComponent);
  ...
  it('scrolling near the bottom loads the next page and appends (not replaces)', fakeAsync(() => {
    const loadPage = vi.fn((q: string, p: number) => of(page(p, 3)));
    const fixture = TestBed.createComponent(DropdownAsyncScrollableComponent);
    fixture.componentRef.setInput('loadPage', loadPage);
    fixture.detectChanges();
  ...
  it('does not trigger another load while one is already in flight', fakeAsync(() => {
  ...
  it('does not load further pages once hasMore is false', fakeAsync(() => {
  ...
  it('typing a new search resets to page 0 and replaces (not appends) the list', fakeAsync(() => {
    const loadPage = vi.fn((q: string, p: number) => of(page(p, 3)));
    const fixture = TestBed.createComponent(DropdownAsyncScrollableComponent);
    fixture.componentRef.setInput('loadPage', loadPage);
    fixture.detectChanges();
  ...
  it('a loadPage() that throws synchronously resolves to an empty page instead of crashing', fakeAsync(() => {
    const fixture = TestBed.createComponent(DropdownAsyncScrollableComponent);
